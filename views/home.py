...
def show_home():
    ...
    st.markdown("""
        <div class="description-card">
            ...
            <div class="desc-body">
                Alat ini menggunakan kuesioner <b>IPSS <i>(Skor Gejala Prostat Internasional)</i></b>, standar medis yang digunakan dokter di seluruh dunia untuk mendeteksi dini pembesaran prostat (BPH).
                <br><br>
